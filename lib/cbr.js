                    ...
                    function(err, updatedCurrencyQuotes) {
                      if(!err) {
                        ...
                        updatedCurrencyQuotes.save(function(err, currencyQuotes) {
                          if(!err) {
                            let selectedRates = [];
                            currencyQuotes.rates.forEach(function(currencyRate){
                              if(this.date.getTime() == currencyRate.date.getTime()) {
                                selectedRates.push(currencyRate);
                              }

                            }.bind(this));
                            currencyQuotes.rates = selectedRates;
